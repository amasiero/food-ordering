...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder() {
    return new me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel other) {
    if (other == null) {
      return new me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.RestaurantApprovalResponseAvroModel.Builder clearFailureMessages() {
