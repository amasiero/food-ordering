...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID paymentId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus paymentOrderStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: paymentOrderStatus = (me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus)value$; break;
   ...
   */
  public me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus value) {
   ...
   */
  public static me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder newBuilder() {
    return new me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder();
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder other) {
    if (other == null) {
      return new me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel other) {
    if (other == null) {
      return new me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setPaymentId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentId() {
      paymentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setPaymentOrderStatus(me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentOrderStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public me.amasiero.food.ordering.order.avro.model.PaymentResponseAvroModel.Builder clearFailureMessages() {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[7] ? this.paymentOrderStatus : (me.amasiero.food.ordering.order.avro.model.PaymentOrderStatus) defaultValue(fields()[7]);
